...
export const BUILDINGS: Record<BuildingTypeId, BuildingDef> = {
  ...
  weaver: {
    id: "weaver",
    name: "Weaver's Hut",
    description: "Weaves Reeds into Cloth — a valuable trade good from the wetlands.",
    age: 1,
    footprint: { w: 1, h: 1 },
    ...
    spriteAlias: "toolmaker",
    upgrades: TOOLMAKER_TREE,
    recipe: { inputs: { reeds: 1 }, outputs: { cloth: 1 }, cycleTicks: 18 },
  },
  glassworks: {
    id: "glassworks",
    name: "Glassworks",
    description: "Melts Sand into Glass — a valuable trade good from the deserts.",
    age: 1,
    footprint: { w: 1, h: 1 },
    ...
    spriteAlias: "toolmaker",
    upgrades: TOOLMAKER_TREE,
    recipe: { inputs: { sand: 1 }, outputs: { glass: 1 }, cycleTicks: 20 },
  },
  storage: {
    id: "storage",
    name: "Storage Hut",
